...
import com.lizehao.watermelondiarynew.Activity.Main2Activity;
import com.lizehao.watermelondiarynew.Activity.MenuActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initTitle() {
        StringBuilder stringBuilder1 = GetDate.getDay();
        StringBuilder stringBuilder2 = GetDate.getMonth();
        StringBuilder stringBuilder3 = GetDate.getYear();
        mMainTvDate.setText("今天，二零一九年四月二十六日");
